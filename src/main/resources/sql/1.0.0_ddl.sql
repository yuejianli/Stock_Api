...
(
    ...
    `all_money`        decimal(10, 4)                                          NULL DEFAULT NULL COMMENT '总的市值',
    `float_money`      decimal(10, 4)                                          NULL DEFAULT NULL COMMENT '浮动盈亏',
    `today_money`      decimal(10, 4)                                          NULL DEFAULT NULL COMMENT '今日浮动盈亏',
    `float_proportion` decimal(6, 4)                                           NULL DEFAULT NULL COMMENT '盈亏比例',
...
(
    ...
    `all_money`        decimal(10, 4)                                          NULL DEFAULT NULL COMMENT '总的市值',
    `float_money`      decimal(10, 4)                                          NULL DEFAULT NULL COMMENT '浮动盈亏',
    `today_money`      decimal(10, 4)                                          NULL DEFAULT NULL COMMENT '今日盈亏金额',
    `float_proportion` decimal(6, 4)                                           NULL DEFAULT NULL COMMENT '盈亏比例',
    `user_id`          int                                                     NULL DEFAULT NULL COMMENT '员工编号',
    `mock_type`        int                                                     NULL DEFAULT NULL COMMENT '类型,1为虚拟 0为正式',
    PRIMARY KEY (`id`) USING BTREE,
