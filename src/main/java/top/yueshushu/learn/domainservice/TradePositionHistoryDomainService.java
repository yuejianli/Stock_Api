...
public interface TradePositionHistoryDomainService extends IService<TradePositionHistoryDo> {
     ...
     */
    List<TradePositionHistoryDo> listPositionHistoryAndDate(Integer userId, Integer mockType, String code, DateTime startDate, DateTime endDate);
     ...
     * @param code     股票编码
     */
    TradePositionHistoryDo getLastRecordByCode(Integer userId, Integer mockType, String code);
}
