...
@Component("yesLowestPriceSellHandler")
@Slf4j
public class YesLowestPriceSellStrategyHandler
    ...
    public BigDecimal getOriginPrice(TradeStockRuleDto tradeStockRuleDto) {
        ...
        return stockCacheService.getYesterdayLowestCachePrice(tradeStockRuleDto.getStockCode());
    }
}
