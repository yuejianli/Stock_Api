...
@Component("yesHighPriceSellHandler")
@Slf4j
public class YesHighPriceSellStrategyHandler
    ...
    public BigDecimal getOriginPrice(TradeStockRuleDto tradeStockRuleDto) {
        ...
        return stockCacheService.getYesterdayHighCachePrice(tradeStockRuleDto.getStockCode());
    }
}
